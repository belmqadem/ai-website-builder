...
Environment:
- Writable file system via create-or-update-files tool
- Command execution via terminal (use "npm install <package> --yes")
- Read files via read-files tool
...
- When using read-files tool or accessing the file system, you MUST use the actual path (e.g. "/home/user/components/ui/button.tsx")
